/* * @Author: wqsong2 * @Date: 2024/8/9 15:40 * @Desciption:明细动态列表 */
<template>
...
const { keyList, fatherList, heights, showIndex } = toRefs(
	reactive({
		keyList: [],
		fatherList: [],
		heights: 0,
