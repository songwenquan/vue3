    ...
    <div class="main-moudle mt10">
      <div class="module-1 moudle">
        ...
        <div class="module-item module-right" >
          ...
          <PieChart class="mt10" style="width: 100%;height:88%;" ref="sourceOfIndicators" pieChart="sourceOfIndicators"
                    :radius="radius"></PieChart>
        </div>
      </div>
      <div class="module-2 moudle mt10">
        ...
        <div class="module-item module-right" >
          ...
          <PieChart class="mt10" style="height: 280px" ref="exception" pieChart="exception" :radius="['60%', '90%']"
                    text-align='center' title-left="49%"></PieChart>
          <div class="btn-group">
            <span>异常指标</span>
            <span>正常指标</span>
            <span>异常率</span>
...
import lineChartBasic from '@/components/echarts/lineChart/lineChartBasic';
